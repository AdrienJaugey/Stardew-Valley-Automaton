/*
 * sprite du doppelganger
 */
package stardewvalleyautomaton.IHM.Sprites.Personnages;

import stardewvalleyautomaton.IHM.Sprites.Enum_IHM_Sprite;
import static stardewvalleyautomaton.IHM.Sprites.Enum_IHM_Sprite.IHM_Doppelganger;

/**
 *
 * @author Matthieu
 */
public class IHM_Sprite_Doppelganger extends IHM_Sprite_Personnage {

    private static final int NOMBRE_MODIFIEUR = 134;                            //nombre de modifieurs différents
    
    //CONSTRUCTEUR -------------------------------------------------------------
    public IHM_Sprite_Doppelganger() {
        super("Doppelganger", NOMBRE_MODIFIEUR);
