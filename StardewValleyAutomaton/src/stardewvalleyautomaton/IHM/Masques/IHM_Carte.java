...
public class IHM_Carte {    
    ...
    public void ajouterDoppelganger(int ligne, int colonne) {
        //creation et enregistrement de l'IHM_Personnage
        IHM_Personnage ihm_personnage = new IHM_Personnage(carte.getCase(ligne, colonne).getPersonnage());
        this.listeDesPersonnages.add(ihm_personnage);
        
        //création et enregistrement des sprites
        ihm_personnage.addSprite(this.niveau[1].setSprite(Fabrique_IHM_Sprite.create(Doppelganger,0), ligne, colonne));
        if(ligne-1>=0) {
            ihm_personnage.addSprite(this.niveau[2].setSprite(Fabrique_IHM_Sprite.create(Doppelganger,100), ligne-1, colonne));
        }
    }
