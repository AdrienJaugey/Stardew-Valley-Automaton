...
import static stardewvalleyautomaton.Model.Personnages.Enum_Personnage.Doppelganger;
...
public class Doppelganger extends Personnage {
    ...
    public void traire() {
        ...
        for(Personnage vache : listeDesVaches) {
            if(lait) {
                System.out.println("Doppelganger a déjà du lait sur elle");
            }
    ...
    public void produireFromage() {
        ...
        if(presenceMachine && this.lait && !this.fromage) {
            this.lait = false;
            this.fromage = true;
            System.out.println("Doppelganger a fait du fromage");
        }
        else {
            if(this.fromage) {
                System.err.println("Doppelganger a déjà du fromage sur elle !");
            }
            if(!this.lait) {
                System.err.println("Doppelganger n'a pas de lait !");
            }
            if(!presenceMachine) {
                System.err.println("Doppelganger n'est pas à côté de la machine !");
            }
        }
    }
    ...
    public void collecterOeuf() {
        ...
        if(success) {
            System.out.println("Doppelganger a ramassé un oeuf");
        }
        else {
